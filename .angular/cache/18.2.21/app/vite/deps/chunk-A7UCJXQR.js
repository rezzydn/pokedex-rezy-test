...
var n = (n2) => {
  ...
  const l = Object.assign({
    ...
    maxAngle: 40,
    threshold: 10
  }, n2), v = l.canStart, m = l.onWillStart, p = l.onStart, f = l.onEnd, y = l.notCaptured, _ = l.onMove, h2 = l.threshold, b = l.passive, D = l.blurOnStart, E = {
    type: "pan",
    startX: 0,
    startY: 0,
    startTime: 0,
  ...
  })(l.direction, l.threshold, l.maxAngle), L = h.createGesture({
    name: n2.gestureName,
    priority: n2.gesturePriority,
    disableScroll: n2.disableScroll
  }), X = () => {
    c && (u = false, _ && _(E));
...
@ionic/core/components/p-BYRVyMu9.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-A7UCJXQR.js.map
