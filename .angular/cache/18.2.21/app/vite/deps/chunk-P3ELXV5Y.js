...
var r = (t3) => {
  ...
  const W2 = t3, I2 = [], K = [], M2 = [], P3 = [], Y = [], Z = [], q2 = [], x = [], H = [], z = [], B = [], G = "function" == typeof AnimationEffect || void 0 !== d2 && "function" == typeof d2.AnimationEffect, J = "function" == typeof Element && "function" == typeof Element.prototype.animate && G, L2 = () => B, N = (e, o) => {
    ...
    t4 > -1 && o.splice(t4, 1);
  }, O = (e, o) => (((null == o ? void 0 : o.oneTimeCallback) ? K : I2).push({
    c: e,
    o
  }), p2), Q = () => {
    J && (B.forEach((e) => {
  ...
  return p2 = {
    ...
    destroy: (e) => (Y.forEach((o) => {
      ...
      Q(), e2 && U2();
    })(e), P3.length = 0, Y.length = 0, y2.length = 0, I2.length = 0, K.length = 0, b2 = false, D2 = true, p2),
    keyframes: (e) => {
      const o = y2 !== e;
      return y2 = e, o && ((e2) => {
        J && L2().forEach((o2) => {
...
var h = (n3) => __async(void 0, null, function* () {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (yield import("./p-DX5m9g56-5KTVAXER.js")).iosTransitionAnimation : (yield import("./p-Dw7GNDKq-QTGFQZHS.js")).mdTransitionAnimation;
});
var y = (n3, e) => __async(void 0, null, function* () {
  ...
  return e.progressCallback && e.progressCallback(void 0), a && V(e.enteringEl, e.leavingEl), {
    hasCompleted: a,
    animation: i2
  };
});
var P2 = (e) => __async(void 0, null, function* () {
  ...
  return yield k(e, o), C(i2, a), V(i2, a), {
    hasCompleted: true
  };
});
...
var D = (n3, e) => __async(void 0, null, function* () {
  n3 && (yield n3(e));
});
var j = (n3, e) => {
...
var M = (n3) => __async(void 0, null, function* () {
  const e = n3;
  if (e) {
...
@ionic/core/components/p-BDd9Zrb9.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-P3ELXV5Y.js.map
