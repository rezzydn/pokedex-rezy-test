...
var r2 = (o, s2, e2, r3, i2, l2, f, p, d) => {
  ...
  const w = a(r3).querySelector("ion-icon").getBoundingClientRect(), k = s2 ? w.width / 2 - (w.right - i2.right) + "px" : i2.left - w.width / 2 + "px", T = s2 ? `-${window.innerWidth - i2.right}px` : `${i2.left}px`, A = `${d.top}px`, j = `${i2.top}px`, B = e2 ? [{
    ...
    opacity: 1,
    transform: "scale(1)"
  }], O = r(), S = r(), z = r(), C = n("ion-back-button"), D = a(C).querySelector(".button-text"), R = a(C).querySelector("ion-icon");
  C.text = r3.text, C.mode = r3.mode, C.icon = r3.icon, C.color = r3.color, C.disabled = r3.disabled, C.style.setProperty("display", "block"), C.style.setProperty("position", "fixed"), S.addElement(R), O.addElement(D), z.addElement(C), z.beforeStyles({
    position: "absolute",
    top: "0px",
    [X]: "0px"
  }).beforeAddWrite(() => {
...
@ionic/core/components/p-DX5m9g56.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XDZC36S6.js.map
